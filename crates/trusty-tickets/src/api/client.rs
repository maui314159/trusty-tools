...
use crate::api::config::{BackendConfig, Config};
...
mod tests {
    ...
    impl Backend for FakeBackend {
        ...
        async fn create_issue(
            &self,
            _p: crate::api::backends::CreateIssueParams,
        ) -> Result<crate::api::models::Issue> {
            unimplemented!()
        }
        async fn get_issue(&self, _id: &str) -> Result<crate::api::models::Issue> {
            unimplemented!()
        }
        async fn update_issue(
            &self,
            _id: &str,
            _p: crate::api::backends::UpdateIssueParams,
        ) -> Result<crate::api::models::Issue> {
            unimplemented!()
        }
        ...
        async fn reopen_issue(&self, _id: &str) -> Result<crate::api::models::Issue> {
            unimplemented!()
        }
        async fn list_issues(
            &self,
            _p: crate::api::backends::ListIssuesParams,
        ) -> Result<Vec<crate::api::models::Issue>> {
            unimplemented!()
        }
        async fn search_issues(
            &self,
            _p: crate::api::backends::SearchIssuesParams,
        ) -> Result<Vec<crate::api::models::Issue>> {
            unimplemented!()
        }
        async fn add_comment(&self, _i: &str, _b: &str) -> Result<crate::api::models::Comment> {
            unimplemented!()
        }
        async fn list_comments(&self, _i: &str) -> Result<Vec<crate::api::models::Comment>> {
            unimplemented!()
        }
        ...
        async fn list_labels(&self) -> Result<Vec<crate::api::models::Label>> {
            unimplemented!()
        }
        ...
        async fn list_milestones(&self) -> Result<Vec<crate::api::models::Milestone>> {
            unimplemented!()
        }
        async fn create_milestone(
            &self,
            _p: crate::api::backends::CreateMilestoneParams,
        ) -> Result<crate::api::models::Milestone> {
            unimplemented!()
        }
        async fn close_milestone(&self, _id: &str) -> Result<crate::api::models::Milestone> {
            unimplemented!()
        }
        async fn get_milestone_issues(&self, _id: &str) -> Result<Vec<crate::api::models::Issue>> {
            unimplemented!()
        }
        async fn list_projects(&self) -> Result<Vec<crate::api::models::Project>> {
            unimplemented!()
        }
        async fn get_project(&self, _id: &str) -> Result<crate::api::models::Project> {
            unimplemented!()
        }
        async fn list_epics(&self) -> Result<Vec<crate::api::models::Issue>> {
            unimplemented!()
        }
        async fn get_epic_issues(&self, _id: &str) -> Result<Vec<crate::api::models::Issue>> {
            unimplemented!()
        }
        async fn create_project_update(
            ...
            _b: &str,
            _h: Option<&str>,
        ) -> Result<crate::api::models::ProjectUpdate> {
            unimplemented!()
        }
        async fn list_project_updates(
            &self,
            _p: &str,
        ) -> Result<Vec<crate::api::models::ProjectUpdate>> {
            unimplemented!()
        }
        async fn list_states(&self) -> Result<Vec<String>> {
            unimplemented!()
        }
        async fn transition_issue(&self, _id: &str, _s: &str) -> Result<crate::api::models::Issue> {
            unimplemented!()
        }
        async fn assign_issue(&self, _id: &str, _a: &str) -> Result<crate::api::models::Issue> {
            unimplemented!()
        }
    }
}
