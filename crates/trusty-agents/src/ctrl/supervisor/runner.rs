...
impl CtrlSupervisor {
    ...
    /// `trusty-agents --workflow prescriptive --project-dir ... --task ... --out-dir ...`,
...
/// Spawn `trusty-agents --workflow prescriptive ...` as a child and await its exit.
///
...
async fn spawn_workflow(
    ...
    let exe = std::env::current_exe().context("locating trusty-agents executable")?;
