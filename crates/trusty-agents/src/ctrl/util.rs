...
/// Detect trusty-agents's own project root. (#182)
///
/// Why: When CTRL runs from a checkout/build of trusty-agents itself, we want to
...
/// Append one bus envelope to `~/.trusty-agents/sessions/pm-messages.jsonl`.
///
...
/// Resolve `~/.trusty-agents/sessions/pm-messages.jsonl`.
