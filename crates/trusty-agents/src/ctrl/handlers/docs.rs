...
//!
//! Why: Lets CTRL answer "how does trusty-agents work?" questions by scanning the
...
impl ToolExecutor for SearchDocsTool {
    ...
    fn schema(&self) -> Value {
        json!({
            ...
            "function": {
                "name": "search_docs",
                "description": "Search project documentation semantically. Use this to answer questions about how trusty-agents works, its configuration, agents, skills, and workflows.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "query": {
