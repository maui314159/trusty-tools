...
//! `trusty-agents postmortem` CLI subcommand.
...
/// inspect the local `.trusty-agents/state/mistakes/<session>.jsonl` file.
...
/// #186: `trusty-agents postmortem [--session <id>] [--last N]` subcommand.
///
...
/// Test: Manual smoke (`trusty-agents postmortem --last 5`); the helper logic is
