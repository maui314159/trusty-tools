...
//!
//! Why: CTRL needs to answer questions about how open-mpm works (configuration,
...
mod tests {
    ...
    fn docs_index_finds_relevant_document() {
        ...
        fs::write(
            dir.join("agents.md"),
            "# Agents\n\nopen-mpm agents are defined in TOML files. Each agent has a model and system prompt.\n",
        )
        .unwrap();
        fs::write(
