//! Per-project TOML config under `.open-mpm/projects/<name>.toml`.
//!
...
//! restarts and is human-editable. Putting it under `.open-mpm/projects/`
...
//! `.open-mpm/projects/` path). Configs are TOML with `[project]` and
...
//! [project]
//! name = "open-mpm"
//! path = "/Users/masa/Projects/open-mpm"
...
/// Full project config (one TOML file under `.open-mpm/projects/`).
///
...
/// What: Holds the base directory (e.g., `<project>/.open-mpm/projects/`)
