...
//!      That coupled `open-mpm` directly to every agent's tool surface and
...
//!      construct their tool list and hand it to `open-mpm` as a plugin,
...
pub use open_mpm_agent_api::AgentPlugin;
...
mod tests {
    ...
    /// Test: `cargo test -p open-mpm agent_plugin_lookup_returns_matching_plugin`.
    #[test]
