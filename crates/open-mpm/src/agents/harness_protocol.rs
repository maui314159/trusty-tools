...
//! content. Any agent running inside the open-mpm harness MUST follow these
...
/// Contains only the minimum protocol required to operate within open-mpm.
pub const BASE_PROTOCOL: &str = r#"
## open-mpm Harness Protocol
